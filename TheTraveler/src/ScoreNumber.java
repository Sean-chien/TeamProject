...
public class ScoreNumber {
    ...
    public static int[][] numberData = {{576, 200}, {578, 236}, {578, 268}, {578, 300}, {574, 346}, {574, 370}, {330, 490}, {350, 490}, {370, 490}, {390, 490}};
    ...
    public void drawScore(Scene t, int x, int y) {
        for (int i = 0; i < snumber.length(); i++) {
            drawNumber(t, Integer.parseInt(snumber.substring(i, i + 1)), x + 15 * i, y);
        }
    }

    public void drawRecord(Scene t, int x, int y) {
    ...
    public void drawNumber(Scene t, int number, int x, int y) {
        t.image("art.png", numberData[number][0], numberData[number][1], 14, 20, 0, x, y);
    }
}
